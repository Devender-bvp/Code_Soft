...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            render = PhotoImage(file='FaceRecognition\homepagepic.png')
...
app = MainUI()
app.iconphoto(False, tk.PhotoImage(file='FaceRecognition\icon.ico'))
app.mainloop()
