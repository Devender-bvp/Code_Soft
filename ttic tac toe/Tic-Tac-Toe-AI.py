...
class TIC_TAC_TOE_AI:
    def __init__(self, root):
        ...
        self.window = root
        self.make_canvas = Canvas(self.window, background="#ec7475", relief=RAISED, bd=3)
    ...
    def decorating(self):# Basic Set-up
        Label(self.make_canvas, text="Tic-Tac-Toe AI", bg="#ec7475", fg="#740f10", font=("Lato", 25, "bold")).place(x=110, y=10)
        self.btn_1 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#acc6ad", activebackground="#262626", bd=3, command=lambda: self.__human_play(1), state=DISABLED)
        self.btn_1.place(x=20,y=100)
        self.btn_2 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#acc6ad", activebackground="#262626", bd=3, command=lambda: self.__human_play(2), state=DISABLED)
        self.btn_2.place(x=190,y=100)
        self.btn_3 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#acc6ad", activebackground="#262626", bd=3, command=lambda: self.__human_play(3), state=DISABLED)
        self.btn_3.place(x=360,y=100)

        self.btn_4 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#acc6ad", activebackground="#262626", bd=3, command=lambda: self.__human_play(4), state=DISABLED)
        self.btn_4.place(x=20,y=200)
        self.btn_5 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#acc6ad", activebackground="#262626", bd=3, command=lambda: self.__human_play(5), state=DISABLED)
        self.btn_5.place(x=190,y=200)
        self.btn_6 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#acc6ad", activebackground="#262626", bd=3, command=lambda: self.__human_play(6), state=DISABLED)
        self.btn_6.place(x=360,y=200)

        self.btn_7 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#acc6ad", activebackground="#262626", bd=3, command=lambda: self.__human_play(7), state=DISABLED)
        self.btn_7.place(x=20,y=300)
        self.btn_8 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#acc6ad", activebackground="#262626", bd=3, command=lambda: self.__human_play(8), state=DISABLED)
        self.btn_8.place(x=190,y=300)
        self.btn_9 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#acc6ad", activebackground="#262626", bd=3, command=lambda: self.__human_play(9), state=DISABLED)
        ...
        self.machine_first_control = Button(self.make_canvas, text="Machine vs Human", font=("Arial", 15, "bold", "italic"), bg="#acc6ad", activebackground="#262626", fg="#740f10", relief=RAISED, bd=3, command=lambda: self.control_give("machine_first"))
        self.machine_first_control.place(x=15, y=380)

        self.human_first_control = Button(self.make_canvas, text="Human vs Machine", font=("Arial", 15, "bold", "italic"), bg="#acc6ad", activebackground="#262626", fg="#740f10", relief=RAISED, bd=3, command=self.control_give)
        self.human_first_control.place(x=240, y=380)

        self.reset_btn = Button(self.make_canvas, text="Reset", font=("Arial", 15, "bold", "italic"), bg="#acc6ad", activebackground="#262626", disabledforeground="grey", fg="#740f10", relief=RAISED, bd=3, command=self.reset, state=DISABLED)
    ...
    def __machine_play(self):# Machine Control
        mixer.init()
        mixer.music.load('.\\ttic tac toe\\1.mp3')
        mixer.music.play()
    ...
    def machine_line_match(self):
        ...
        if self.activate_btn[1-1]['text'] == self.activate_btn[2-1]['text'] == self.activate_btn[3-1]['text'] == "X":
            ...
            found=1
        if found == 1:
            mixer.music.load('.\\ttic tac toe\\computer is winner.mp3')
            mixer.music.play()
            messagebox.showinfo("Game Over", "Computer is winner")
            self.game_over_management()
        elif self.chance_counter == 9:
            mixer.music.load('.\\ttic tac toe\\game draw.mp3')
            mixer.music.play()
    ...
    def human_line_match(self):
        ...
        if self.activate_btn[1-1]['text'] == self.activate_btn[2-1]['text'] == self.activate_btn[3-1]['text'] == "O":
            ...
            found=1
        if found == 1:
            mixer.music.load('.\\ttic tac toe\\you are winner.mp3')
            mixer.music.play()
